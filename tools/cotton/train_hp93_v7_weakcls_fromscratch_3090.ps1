...
$Config = "configs\cotton\rtv4_hgnetv2_m_cotton_v7_weakcls_fromscratch_768.yml"
$Output = "outputs\rtv4_hgnetv2_m_cotton_v7_weakcls_fromscratch_768"
...
Write-Host "Starting v7 weak-class from-scratch training"
