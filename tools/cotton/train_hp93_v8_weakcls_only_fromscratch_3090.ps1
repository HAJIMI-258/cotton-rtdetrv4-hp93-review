...
$Config = "configs\cotton\rtv4_hgnetv2_m_cotton_v8_weakcls_only_fromscratch_768.yml"
$Output = "outputs\rtv4_hgnetv2_m_cotton_v8_weakcls_only_fromscratch_768"
...
Write-Host "Starting v8 weak-class-only from-scratch training"
